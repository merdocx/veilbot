...
# CryptoBot
CRYPTOBOT_API_TOKEN = _settings.CRYPTOBOT_API_TOKEN
CRYPTOBOT_API_URL = _settings.CRYPTOBOT_API_URL
CRYPTOBOT_WEBHOOK_SECRET = _settings.CRYPTOBOT_WEBHOOK_SECRET
CRYPTOBOT_DEFAULT_ASSET = _settings.CRYPTOBOT_DEFAULT_ASSET
CRYPTOBOT_DEFAULT_NETWORK = _settings.CRYPTOBOT_DEFAULT_NETWORK
...
FREE_V2RAY_TARIFF_ID = _settings.FREE_V2RAY_TARIFF_ID
FREE_V2RAY_COUNTRY = _settings.FREE_V2RAY_COUNTRY
OUTLINE_SERVER_ID = _settings.OUTLINE_SERVER_ID
...
__all__ = [
    ...
    'CRYPTOBOT_API_TOKEN', 'CRYPTOBOT_API_URL', 'CRYPTOBOT_WEBHOOK_SECRET',
    'CRYPTOBOT_DEFAULT_ASSET', 'CRYPTOBOT_DEFAULT_NETWORK',
    'FREE_V2RAY_TARIFF_ID', 'FREE_V2RAY_COUNTRY', 'OUTLINE_SERVER_ID'
]
