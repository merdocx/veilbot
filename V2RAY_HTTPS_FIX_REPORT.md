...
**Результат:**
```
13|Amsterdam 3|http://veil-bird.ru/api||veil-bird.ru|***REMOVED***|/usr/local/bin/xray|v2ray
```
...
**Результат:**
```
13|Amsterdam 3|https://veil-bird.ru/api||veil-bird.ru|***REMOVED***|/usr/local/bin/xray|v2ray
```
